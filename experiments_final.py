...
def experiment11(train_dataset, test_dataset, model, batch_size, num_classes, epochs, learning_rate):
...
def experiment4(train_dataset, excluded_train_dataset,test_dataset, model, batch_size, num_classes, epochs, learning_rate):
...
def experiment5_helper(train_dataset, test_dataset, model, batch_size, num_classes, epochs, learning_rate, t_name): 
...
def experiment5(train_dataset, test_dataset, model, batch_size, num_classes, epochs, learning_rate):
    ...
    for t_name, transform in transformations.items():
        ...
        overall_mean, accuracy = experiment5_helper(train_dataset, test_dataset, model, batch_size, num_classes, epochs, learning_rate, t_name)
...
def experiment5_without_distance_helper(train_dataset, test_dataset, model, batch_size, num_classes, epochs, learning_rate, t_name): 
    # Create a training set solely from test images transformed with t_name.
    transformed_images = []
    for img, label in test_dataset:
        transform = get_transformations(img).get(t_name)
...
def experiment5_without_distance(train_dataset, test_dataset, model, batch_size, num_classes, epochs, learning_rate):
    print("[Experiment 5] Transformation Impact Analysis")
    transformations = get_transformations(train_dataset[0][0])
    results = {}
    ...
    for t_name, transform in transformations.items():
        print(f"\nProcessing transformation: {t_name}")
        overall_mean, accuracy = experiment5_without_distance_helper(train_dataset, test_dataset, model, batch_size, num_classes, epochs, learning_rate, t_name)
        results[t_name] = (overall_mean, accuracy)
       
    print("\nOverall Transformation Impact Results:")
    for t_name, accuracy in results.items():
        print(f"{t_name}: mean={score:.4f} accuracy={accuracy:.2f}")
...
def main():
    ...
    if experiment == 1:
        ...
        experiment11(train_dataset, test_dataset, model, batch_size, num_classes, epochs, learning_rate)
    elif experiment == 2:
        ...
        experiment4(train_dataset, excluded_train_dataset, test_dataset, model, batch_size, num_classes, epochs, learning_rate)
    elif experiment == 41:
        experiment4_threshold(train_dataset, excluded_train_dataset,test_dataset, model, batch_size, num_classes, epochs, learning_rate)
    elif experiment == 5:
        experiment5(train_dataset, test_dataset, model, batch_size, num_classes, epochs, learning_rate)
    elif experiment == 51:
        experiment5_without_distance(train_dataset, test_dataset, model, batch_size, num_classes, epochs, learning_rate)
